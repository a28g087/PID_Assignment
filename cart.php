...
<table width="780" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <td class="tdbline"><table width="100%" border="0" cellspacing="0" cellpadding="10">
      <tr valign="top">
        <td><div class="subjectDiv"> <span class="heading"><img src="images/16-cube-green.png" width="16" height="16" align="absmiddle"></span> 購物車內容
        </div>
        <div class="actionDiv">
          <?php if(isset($_SESSION["username"])&&$_SESSION["username"]!=""){?>
            <a><?=$_SESSION["username"]?> 歡迎!</a>｜<a href="index.php">首頁</a>｜<a href="orders_view.php">我的訂單</a>｜<a href="index.php?logout=true">登出</a>
            <?php }else{?>
